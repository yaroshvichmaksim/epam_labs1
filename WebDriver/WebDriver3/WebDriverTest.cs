...
namespace WebDriver3
{
    ...
    public class UnitTest1
    {
        ...
        public void Ordering_Ticket_From_Minsk_To_Molodechno_With_An_Email()
        {
            ...
            webDriver.FindElement(By.CssSelector("#ufs-railway-app > div > div.wg-layout__inner-wrap > div.wg-layout__main > div:nth-child(5) > div > div.wg-block__inner.wg-block__inner_border-top.wg-train-options__seats.wg-train-options__seats_visible.wg-order-seats > div:nth-child(2) > div:nth-child(2) > div.wg-order-seats__scheme-wrap > div > div.wg-places-scheme__scheme > div > div > div.wg-carousel__slide.wg-carousel__slide_selected > div > div > div > span:nth-child(37)")).Click();
