...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        public void GetTransportMilitaryPlanes()
        {
            ...
            Assert.IsTrue(transportMilitaryPlanes.All(plane=>plane.PlanType == MilitaryType.TRANSPORT));
        }
        ...
        public void GetPassengerPlaneWithMaxPassengersCapacity()
        {
            ...
            Assert.AreEqual(expectedPlaneWithMaxPassengersCapacity.PassengersCapacity, 
                airport.GetPlanes<PassengerPlane>().Max(plane => plane.PassengersCapacity));
        }
